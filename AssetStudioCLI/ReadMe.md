...
### Usage
```
Usage: AssetStudioModCLI <input path to asset file/folder> [-m, --mode <value>]
                      ...
                      [--audio-format <value>] [--l2d-group-option <value>]
                      [--l2d-motion-mode <value>] [--l2d-search-by-filename]
                      [--l2d-force-bezier] [--fbx-scale-factor <value>]
                      [--fbx-bone-size <value>] [--fbx-uvs-as-diffuse]
                      [--fbx-cast-to-bone] [--filter-by-name <text>]
                      [--filter-by-container <text>] [--filter-by-pathid <text>]
                      [--filter-by-text <text>] [--filter-with-regex]
...
FBX Options:
  ...
  --fbx-cast-to-bone            (Flag) If specified, all nodes will be cast to bone in the FBX output.
